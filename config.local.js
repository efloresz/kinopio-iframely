(function() {
    var config = {
        ...
        */
        ...
        /* From v1.4.0, Iframely works over HTTP/2 if not disabled.
           Alternatively, you can also disable per origin. See `proxy` option below.
           The default in this sample config is to disable HTTP/2 as per
           https://github.com/itteco/iframely/issues/277.
        */
        DISABLE_HTTP2: true,
